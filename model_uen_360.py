...
class UEN(nn.Module):
    def __init__(self,smoothing_kernel_size=41
        ...
        self.upsample_1=nn.Sequential(
            nn.ConvTranspose2d(self.cnn_out_channels, self.cnn_2x_channels, kernel_size=3, stride=2, padding=1, output_padding=(1,1)), #different from 120
        )
        ...
        self.upsample_4=nn.Sequential(
            nn.ConvTranspose2d(self.cnn_4x_channels, self.cnn_4x_channels, kernel_size=3, stride=2, padding=1, output_padding=(1,1)), #different from 120
            nn.BatchNorm2d(self.cnn_4x_channels),
            nn.ReLU(inplace=True),
