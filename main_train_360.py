...
def get_args_parser():
    parser = argparse.ArgumentParser(
        description="train uEn 360", add_help=False
    )
    # dataset folder
    parser.add_argument(
        "--dataset_folder", default="D:/00Dataset/THUE0001_360/", help="dataset folder"
    )
...
def train():
    ...
    #create folder to save different component
    ...
    for view in args.views:
        ...
        # load dataset
        dataset = THUEDataset(
            videos_path=args.dataset_folder+"THUE0001_"+view+"/annotation/",
            mode="train",
            num_frames=16,
        ...
        data_loader_train=torch.utils.data.DataLoader(
            dataset,
            batch_size=args.batch_size if view!="ERP" else args.ERP_batch_size,
            num_workers=10,
            pin_memory=True,
            drop_last=True,
            shuffle=True
